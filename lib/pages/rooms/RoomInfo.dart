...
class RoomInfo extends StatefulWidget {
  ...
  const RoomInfo({Key? key, required this.data, this.type, required this.insideRoom}) : super(key: key);
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              //peek in
                              if (widget.data["membersOnly"] != true)
                                if (!widget.data["isUpcoming"])
                                  if (widget.data["id"] ==
                                          FirebaseAuth
                                              .instance.currentUser!.uid ||
                                      widget.data['inviteOnly'] != true)
                                    widget.type != "activity" && !widget.insideRoom
                                        ? GestureDetector(
                                            onTap: () {
                                              Navigator.push(
                                                context,
                                        ...
                                        : SizedBox.shrink(),
                              (widget.data["membersOnly"] == true)
                                  ? (auth.subscribedBookClubs
                                          .contains(widget.data["bookCubId"]))
                                      ? GestureDetector(
                                          onTap: () {
                                            Navigator.push(
                                              context,
