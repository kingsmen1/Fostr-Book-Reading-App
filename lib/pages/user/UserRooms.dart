...
import 'userActivity/RoomRecordings.dart';

class UserRooms extends StatelessWidget {
  const UserRooms(this.ind, this.userid);
  final int ind;
  final String userid;
...
class LiveUserRoomCards extends StatelessWidget {
  const LiveUserRoomCards(this.id, this.ind, this.userid);
  final String id;
  final int ind;
  final String userid;
  @override
...
class LiveUserRoomCardSingle extends StatefulWidget {
  const LiveUserRoomCardSingle(this.data, this.room, this.type);
  final Map<String, dynamic> data;
  final String type; // random string, only required for All tab in hallway
  final Room room;

  @override
  State<LiveUserRoomCardSingle> createState() => _LiveUserRoomCardSingleState();
}

class _LiveUserRoomCardSingleState extends State<LiveUserRoomCardSingle> {
  bool active = true;
    ...
    return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          switch (snapshot.connectionState) {
            ...
            default:
              return !snapshot.data?.data()?["isDeleted"]
                  ? Padding(
